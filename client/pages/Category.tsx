...
import { Star, ShoppingCart, ChevronRight, Sliders, ArrowUpDown } from 'lucide-react';
...
const Category = () => {
  ...
  const current = categoryData[category || 'tecnologia'] || categoryData['tecnologia'];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 md:py-20 border-b border-border bg-gradient-to-br from-muted/50 to-background">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">{current.description}</p>
        </div>
      </section>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex items-center justify-between mb-8 pb-6 border-b border-border">
                <span className="text-sm text-muted-foreground">
                  Exibindo {startIdx + 1}-{Math.min(startIdx + productsPerPage, filteredProducts.length)} de {filteredProducts.length} produtos
                </span>
